...
const Footer = () => {
  return (
    <footer className="max-container" >
      <div className="flex justify-between items-start gap-20 flex-wrap mx-lg:flex-col">
        <div className="flex flex-col items-start">
          <a href="/">
            <img src={footerLogo} width={150} height={46} alt="footer logo" />
          </a>
          <p className="mt-6 text-bases leading-7 font-montserrat text-white-400 sm:max-w-sm">
